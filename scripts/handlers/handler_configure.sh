...
configure_web_server(){
  ...
  log "INFO" "LE SERVEUR WEB PERMET D'UTILISER LA CONFIGURATION DYNAMIQUE SUR LE SERVEUR $ARK_SERVER_SERVICE."
  log "INFO" "LE SERVEUR WEB PERMET D'UTILISER LA LISTE BLANCHE ADMIN SUR LE SERVEUR $ARK_SERVER_SERVICE."
  log "INFO" "LE SERVEUR WEB PERMET D'UTILISER LA LISTE BLANCHE DES CUSTOM COSMETICS SUR LE SERVEUR $ARK_SERVER_SERVICE."
  log "WARNING" "VOUS DEVREZ CONFIGURER LE SERVEUR WEB AVANT DE CONFIGURER LA CONFIGURATION DYNAMIQUE ET LES AUTRES FONCTIONNALITÉS."
  if prompt confirm "VOULEZ-VOUS CONFIGURER LE SERVEUR WEB POUR LE SERVEUR $ARK_SERVER_SERVICE ? [Oui/Non]"; then
    log "WARNING" "CONFIGURATION DU SERVEUR WEB POUR LE SERVEUR $ARK_SERVER_SERVICE EN COURS."
...
configure_dynamic_config(){
  if check_if_web_server_exist; then
    ...
    if prompt confirm "VOULEZ-VOUS CONFIGURER LA DYNAMIC CONFIG POUR LE SERVEUR $ARK_SERVER_SERVICE ? [Oui/Non]"; then
      log "WARNING" "CONFIGURATION DE LA DYNAMIC CONFIG POUR LE SERVEUR $ARK_SERVER_SERVICE EN COURS."
...
configure_admin_list(){
  if check_if_web_server_exist; then
    ...
    if prompt confirm "VOULEZ-VOUS CONFIGURER LA LISTE BLANCHE ADMIN POUR LE SERVEUR $ARK_SERVER_SERVICE ? [Oui/Non]"; then
      log "WARNING" "CONFIGURATION DE LA LISTE BLANCHE ADMIN POUR LE SERVEUR $ARK_SERVER_SERVICE EN COURS."
